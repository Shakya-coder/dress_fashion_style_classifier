...
# Load the model architecture and weights
model = AdvancedFashionStyleClassifier(num_classes=15)
model.load_state_dict(torch.load('fashion_style_classifier_v7.pth', map_location=torch.device('cpu')))
model.eval()  # Set the model to evaluation mode
...
# Define descriptions for each class
descriptions = {
    'athleisure fashion': 'Athleisure is a combination of athletic and leisurewear...',
    'bohemian fashion': 'Bohemian style is characterized by its free-spirited...',
